...
<title>コミュニケーションページ</title>
<link rel="stylesheet" href="style.css" />
</head>
<body>
<div class="outline">
	<header class="header"><div class="headerdetail"><h1>CommunicationApplication</h1><p id="datetime"></p></div></header>
	<div class="content">
		<span><a href="./member.php"id="member">&laquo;登録ユーザー一覧</a></span>	
		<!--メッセージ投稿・削除方法ポップアップ表示-->
		<label class="open" for="pop-up">メッセージ投稿・削除方法</label>
		<input type="checkbox" id="pop-up">
		<div class="overlay">
			<div class="window">
				<label class="close" for="pop-up">&#x2612;</label>
				<p class="text">メッセージを記入後、&#12300;投稿&#12301;をクリックしてください。メッセージの先頭50文字が表示されます。<br>
				&#91;全文表示&#93;をクリックすると、メッセージ全文が表示されます。&#91;削除&#93;をクリックしてメッセージを削除できます。<br>
				&#9312;&#042;添付ファイルは、拡張子.pdf以外アップロードできません。<br>
				&#9313;&#042;ログインしたアカウント以外のメッセージを削除することはできません。</p>
			</div>
		</div>
			<div><a href="logout.php"id="loginout">ログアウト</a></div>
			<form action="" method="post"enctype="multipart/form-data">
				<dl>
					<dt><?php echo 'ようこそ'.h($name); ?>さん、メッセージをどうぞ</dt>
					<dd>
						<textarea name="message" cols="80" rows="5"></textarea>
					</dd>
					<dd>
						<input type="file" name="pdf" size="35" value=""/>
					</dd>
				</dl>
				<div>
					<p>
